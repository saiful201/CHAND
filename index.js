...
const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! EVERYONE , THIS BOT WAS MADE BY MR CHAND AND FEEL THIS NAME CHAND TRICKER 😜 ");
    res.end();
});
...
startBot();
/*axios.get("https://raw.githubusercontent.com/Mrchandu7/chandv2_fix/main/package.json").then((res) => {
