module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "BerVer",
  description: "Change the color of the conversation continuously according to the given number",
  commandCategory: "system",
  usages: "rainbow [number of times change]",
  cooldowns: 5,
...
module.exports.run = async({
  ...
  var value = args.join();
  if (isNaN(value)) return api.sendMessage(`It's not a number!`, event.threadID, event.messageID);
