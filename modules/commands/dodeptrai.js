module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "DMH",
    description: "Test your handsomeness",
...
if (!args[0]) {
    ...
    var callback = () => api.sendMessage({body:`😎 Your handsomeness ratio ${name}\n[❗] About ${tile}% 😏`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
