module.exports.config = {
    ...
    description: "See the weather for 5 days",
...
module.exports.run = async function ({
    ...
    let msg = `The weather today:\n${dataWeather.Headline.Text}` +
        ...
        `\n🌡 Feeling temperature: ${convertFtoC(dataWeatherToday.RealFeelTemperature.Minimum.Value)}°C - ${convertFtoC(dataWeatherToday.RealFeelTemperature.Maximum.Value)}°C` +
