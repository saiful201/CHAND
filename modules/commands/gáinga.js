...
"https://i.postimg.cc/pTzYs1Lx/t-i-xu-ng-9.jpg",
     ...
     var callback = () => api.sendMessage({body:`Number of photos: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
