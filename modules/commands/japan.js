...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Thanh Dz",
  description: "Cosplay Girl Photo ",
...
"https://i.imgur.com/FhC4jXa.jpg",
   ...
   var callback = () => api.sendMessage({body:`Vietnam Cosplay Photos \Number of Photos: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/49.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/49.jpg"));  
