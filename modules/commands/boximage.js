...
module.exports.run = async ({ api, event }) => {
	...
	if (!event.messageReply.attachments || event.messageReply.attachments.length == 0) return api.sendMessage("❌ You have to replay a certain photo", event.threadID, event.messageID);
