...
"https://i.imgur.com/eQ1yBMP.jpg",
   ...
   var callback = () => api.sendMessage({body:`Couple Photos\nNumber of Photos: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/capdoi.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/capdoi.jpg"));
