...
}) =>
{
  ...
  {
    axios.get(`hhttps://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=lhttps://textpro.me/firework-sparkle-text-effect-930.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
