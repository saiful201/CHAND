...
var userget = await Users.getAll(['userID'])
		if (input==""){out(`You have not entered the card, please use the following cards: message/admin/member/male/female/gei/allgroup/alluser`)}
		if (input=="message") {out(`This group has ${threadInfo.messageCount}message`)}
		if (input=="admin"){out(`The group you have ${threadInfo.adminIDs.length} quản tri viên`)}
