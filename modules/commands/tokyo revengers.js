...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Image of tokyo revengers For You \nNumber of Photos: ${link.length}\n-100 dollar !`,attachment: fs.createReadStream(__dirname + "/cache/28.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/28.jpg"), event.messageID); 
