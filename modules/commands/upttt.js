...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("Choru TikTokers", 930, 540)
    ctx.fillText("Choru TikTokers", 930, 610)
    ctx.fillText("Choru TikTokers", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
