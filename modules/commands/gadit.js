module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 1,
    credits: "Mod Syn Credit, please keep the credit, don't keep it as a dog sucking the cunt",
    description: "Flirting with someone <3",
...
a("Nungws quas why do you use this command <3 :3");
setTimeout(() => {a({body: "Hi there :3 :3" + " " + name, mentions: arraytag})}, 3000);
