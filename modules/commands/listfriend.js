    ...
    case "reply":
      {
        ...
        api.sendMessage(`💢Enforce delete friends💢\n\n${msg}`, threadID, () =>
...
module.exports.run = async function ({ event, api, args }) {
  ...
  try {
    ...
    return api.sendMessage(msg + '🎭Reply ordinal number (from 1->10), can rep multiple numbers, separated by space to remove that friend from the list!', event.threadID, (e, data) =>
