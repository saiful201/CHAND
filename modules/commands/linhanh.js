module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Thắng",
  description: "Your own order, the owner of the bot, if you like it, use it ^^",
...
"https://i.postimg.cc/s28GcT4m/240996627-3018074361783520-1374492060414132441-n.jpg",
     ...
     var callback = () => api.sendMessage({body:`Your own order of the bot owner ^^`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
