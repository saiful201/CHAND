...
try {
  ...
  const canvas = Canvas.createCanvas(500, 500);
	...
	fs.writeFileSync(path_hiepdam,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_hiepdam, {'highWaterMark': 128 * 1024}), body: "So happy ah ah ah..."}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
