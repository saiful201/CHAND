module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "CatalizCS",
    description: "Fortune telling love, career, life",
    commandCategory: "other",
    cooldowns: 5
};

module.exports.run = function ({ api, event }) {
    const data = ["I drew a 2 ♥ Let me see... Uhmm, a very good card. It signals that the child will be supported and helped by a lover or a admirer. So don't worry, if you have any difficulties, he will sympathize and help you.",

        "I drew a 2 ♦ Let me see...Hmm, this piece has a lot of meaning. It can be a harbinger of a business partner, or a change in relationship. I think you should talk to friends and colleagues to better understand what's going on.",

        "You drew a 2 ♣ Let me see... Hmm, this card signals an obstacle. You'll have some trouble before you succeed, and have to watch out for someone spreading bad rumors. I think you have to be more discreet, do everything carefully and thoughtfully.",
        ...
        "You draw a 3 ♥ Let me see... Well, this piece, it's difficult. It usually signals a love triangle. You will find it difficult to choose your true love. Love is not forced. You can't force it, so just relax and let what happens will happen.",
        ...
        "You drew 3 ♣ Let me see...Oh, a card that signals love and happiness. If you want to propose to someone, now is the right time. In addition, it also means: so if there's something that hasn't worked before, and you want to try again, go ahead.",
       ...
       "You drew a 3 ♠ Let me see...Uhmm, this card is not good, it represents a broken relationship. I think someone might be trying to interfere in your relationship. In This time, you should be careful, avoid collisions or quarrels that will break your feelings.",
        ...
        "You drew card 4 ♥ Let me see... Hmmm, this card signals a change in work and home. Maybe in the near future you will have a job transfer or a house move. I think You should just plan ahead or it will update again..",
        ...
        "You drew a 4 ♣ Let me see...This is a warning card. According to me, this time you have to be careful that there are no cheaters or traitors. Read it again, don't be subjective. Wish you luck!",

        "You drew a 4 ♠ Let me see...Son, this piece is often associated with troubles and troubles. I think you should be careful in spending, even in case of loss. In general, It's not too dangerous, don't worry, don't worry too much, in a few days, everything will be in place."
        ...
        "I drew a card 5 ♣ Let me see...This piece is a good omen. In the future you will have many new friends, many helpers, many kind friends. I think you should spend a lot of time. make friends, expand relationships and strengthen old friendships. That will make you happy and comfortable.",
        ...
        "I drew a 7 ♥ Let me see... Well, this card represents an unfaithful, fickle person. Maybe in the near future you'll feel a little *disappointed*, missing someone. I don't get much in return... But it's okay, applying the ointment will heal, I think it will pass quickly. then feeling will also be more certain...",
        ...
        "You drew a 9 ♣ Let me see...Uhmm, this card is a harbinger of success. If you're not married, I think it's very likely that you're going to marry the son of a rich family, if not, my love. you're going to win a big lottery. Besides, it also tells you that you're going to meet a gift from heaven, where does money come from?",
        ...
        "I drew a J card ♦ Let me see...Let me see... J Ro, a neat young man but can also be a jealous person and can't be trusted. I think you will have someone tell you soon The news isn't very good, but it's nothing of great importance. You should be sober when listening to other people at this time.",
        ...
        "I drew a K card ♦ Let me see...Uhmm, let's see.... This piece has the image of a man who dominates the power of the Earth, a man full of power, position and influence. Drawable. With this card, you will soon have good news, usually get a promotion. This time you should be nice to the above bosses as well as colleagues, there will be many opportunities.",

        "You draw a K card ♣ Let me see...Oh, this piece has the image of a kind, generous, enthusiastic old man. You will get help from your superiors, teachers, parents or relatives. I think you may be about to get a new job with a higher salary, a promotion or someone else to give you money.",
        ...
        "You drew a JOKER. Let me see...Pan teh. A card of fate. It is neither a bad omen nor a good omen. Its meaning is that what is to come will come, if you look forward to it. It's not hard to feel bad about something. I think you should just let things happen, don't force them."
    ];
