    ...
    case "-t":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`❎Currently available ${listBanned.length} banned group\n\n${listBanned.join("\n")}` +
          "\n\nReply to this message + the sequence number to unban the corresponding thread",
          threadID, (error, info) => {
    ...
    case "-u":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`❎Currently available ${listBanned.length} users get banned\n\n${listBanned.join("\n")}` +
          "\n\nReply to this message + the sequence number to unban the corresponding user",
          threadID, (error, info) => {
