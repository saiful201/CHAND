module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Dũngkon",
    description: "Kiểm tra độ độ hợp đôi của đôi bạn",
...
if (!args[0]) {
    ...
    var callback = () => api.sendMessage({body:`🥲 Tỉ lệ hợp đôi của bạn và ${name} là Khoảng ${tile}% 💅`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
