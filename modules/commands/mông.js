...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "CallmeSun",
  description: "Random Image of Girl's Butt is very eye-catching (Note This is a photo command 18+ Consider Before Using)",
...
"https://i.imgur.com/nfWKOFk.jpg",
 ...
 "https://i.imgur.com/FVkLWGP.jpg",
  ...
  var money = data.money
      if(money < 100) api.sendMessage("You need 100 dollars to see the photo ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 100})
   var callback = () => api.sendMessage({body:`Supplement your eyes😼\n» Balance: -100 dollars «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
