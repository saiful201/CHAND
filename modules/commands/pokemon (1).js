module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "D-Jukie",
    description: "Raise pokemon, fight to increase combat power!",
...
module.exports.run = async ({ api, event, args, Users }) => {
    ...
    switch (args[0]) {
        ...
        case 'info':
        case '-i': {
            if (!existsSync(path)) { return api.sendMessage('🔍 You have not registered to raise pokemon!', threadID, messageID); }
