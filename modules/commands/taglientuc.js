...
setTimeout(() =>
api.sendMessage({
   body:"Are you ready yet? Let's start" + mentions[mention].replace("@", "") ,
   mentions: [{
...
setTimeout(() =>
api.sendMessage("Hah...huh...uh... 🌬", threadID), 3000)
...
setTimeout(() =>
api.sendMessage({
   body: "Enchantix "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "That Japanese girl is so far away "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Fuck me eh... "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Go give birth goodbye! " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Where are you go, baby " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Slut mom come back "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"I'm the storm, you're the tree, I'm the tree, I'll meet you " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "I'm Milo, when I'm tired, you dance againt "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Then you win, I lose. " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Sorry, okay??. "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Drink coke hong? " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Up is up is up " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Sweetheart, brother "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
