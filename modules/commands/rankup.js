...
let random = Math.floor(Math.random() * 7) + 1;
		...
		if (existsSync(__dirname + `/noprefix/rankup/rankup${random}.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/noprefix/rankup/rankup${random}.gif`), mentions: [{ tag: name, id: senderID }] };
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "{name}  Iyong ka pogian nasa level na  {level}",
	}
}
