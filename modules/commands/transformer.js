...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome?text=${encodeURIComponent(juswa)}&theme=transformer&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
