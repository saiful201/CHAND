...
}) =>
{
  ...
  {
    axios.get(`hhttps://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/create-impressive-glitch-text-effects-online-1027.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
