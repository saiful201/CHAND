module.exports.config = {
	...
	description: "random number according to max min limit", // Thông tin chi tiết về lệnh
...
module.exports.run = function({ api, event, args, client, __GLOBAL }) {
    ...
    if (!args.join("") != " " ) return api.sendMessage("Parameter not entered", event.threadID, event.messageID);
	else 
    var x = args[0];
