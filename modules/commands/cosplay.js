module.exports.config = {
  ...
  hasPermssion: 2,
  credits: "HChong",
  description: "LOOK AT GIRLS, FRIENDS",
...
module.exports.run = async function ({ event, api }) {
    ...
    api.sendMessage({body: `digital photo : (${stt}/${length})`,attachment: fs.createReadStream(__dirname + `/cache/${event.senderID}-${event.threadID}.png`)}, event.threadID, () => fs.unlinkSync(__dirname + `/cache/${event.senderID}-${event.threadID}.png`), event.messageID);
