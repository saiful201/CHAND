module.exports.config = {
	...
	usages: "Tag 1 person being pointed",
	cooldowns: 5,
	dependencies: {
	  "fs-extra": "",
	  "axios": "",
...
try {
  ...
  const canvas = Canvas.createCanvas(500, 500);
	...
	fs.writeFileSync(path_chitay,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_chitay, {'highWaterMark': 128 * 1024}), body: "The whole world is pointing at you"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
