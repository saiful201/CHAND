...
`, attachment: fs.createReadStream(__dirname + "/cache/joinmp4/hello.gif")} ,threadID));
		...
		try {
			...
			(typeof threadData.customJoin == "undefined") ? msg = "HELLO! {name}. Welcome to {threadName}\n{type} or Member You are the {soThanhVien} member of this group" : msg = threadData.customJoin;
			msg = msg
			.replace(/\{name}/g, nameArray.join(', '))
			.replace(/\{type}/g, (memLength.length > 1) ?  'You' : 'Member')
